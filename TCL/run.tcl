...
set myFiles [list L_2_1_0_SRAM_test.v]   ;# All your HDL files
set basename L_2_1_0_SRAM_test   ;# name of top level module
...
set runname _ASIC             ;# name appended to output files
