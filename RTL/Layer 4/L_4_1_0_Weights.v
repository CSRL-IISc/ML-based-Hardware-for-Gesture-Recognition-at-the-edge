...
module L_4_1_0_Weights #(
    ...
    always @(*) begin
        case(state)
			...
			HOLD	   : next_state = start ? READ : HOLD;
    ...
    // ============================================================
    (* dont_touch = "true" *) TSDN65LPLLA384X8M8F S1 ( .AA(aa_1), .DA(da_1), .BWEBA(bwe_1), .WEBA(we_1), .CEBA(ce_1),
        .CLKA(clk), .QA(read_data_01), .AB(9'd0), .DB(8'd0), .BWEBB({N{1'b1}}),
        .WEBB(1'b1), .CEBB(1'b1), .CLKB(1'b0), .AMA(9'd0), .DMA(8'd0),
        .BWEBMA({N{1'b1}}), .WEBMA(1'b1), .CEBMA(1'b1),
        .AMB(9'd0), .DMB(8'd0), .BWEBMB({N{1'b1}}), .WEBMB(1'b1),
